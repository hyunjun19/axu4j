...
<!-- @@@@@@@@@@@@@@@@@@@@@@ js end   @@@@@@@@@@@@@@@@@@@@@@ -->
	...
	var topMenu_data = [
		{_id:"m01", label:"사이트소개", url:"main/sample_menu/EgovAboutSite", cn:[
            {_id:"m0101", label:"소개", url:"EgovPageLink.do?menuNo=11&link=main/sample_menu/EgovAboutSite"}
        ]},
		{_id:"m02", label:"정보마당", url:"main/sample_menu/EgovProductInfo", cn:[
			{_id:"m0201", label:"서브페이지", url:"#ax"},
			{_id:"m0202", label:"서브페이지 두번째", url:"#ax"},
			{_id:"m0203", label:"서브페이지 세번째", url:"content.jsp"}
		]},
		{_id:"m03", label:"고객지원", url:"content.jsp"},
		{_id:"m04", label:"알림마당", url:"content.jsp"},
		{_id:"m05", label:"사이트관리(관리자)", url:"content.jsp"}
    ];
    var sideMenu_data = [
